...
class CaptionGenerator:
    def __init__(self, image_root, model_path, main_gpus, sample_num):
    ...
    def generate(self, data_path, output_path, questions_path):
        # 加载数据
        ...
        prompt_chunks = [inputs[i:i+chunk_size] for i in range(0, len(inputs), chunk_size)]
        item_map_chunks = [dataset[i:i+chunk_size] for i in range(0, len(dataset), chunk_size)]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--sample_num", type=int, default=1, help="每个样本生成数量")
