...
MODEL_BASE=/data/yanshi.xy/MLLM_RAFT/Qwen2.5-VL-Finetune/qwen_models_raft_rw0
OUTPUT_DIR=/data/yanshi.xy/MLLM_RAFT/Qwen2.5-VL-Finetune/qwen_mathverse_rw0
...
for i in {1..6};do
    ...
    if [ ! -f "$ANSWER_FILE" ]; then
        ...
        CUDA_VISIBLE_DEVICES=5 python evaluation/infer_mathverse.py \
