...
MODEL_BASE=/data/yanshi.xy/MLLM_RAFT/Qwen2.5-VL-Finetune/cold_start_fixUnderfitting
OUTPUT_DIR=/data/yanshi.xy/MLLM_RAFT/Qwen2.5-VL-Finetune/qwen_mathverse_test_cold_start
