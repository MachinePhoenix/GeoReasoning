...
MODEL_BASE=/data/yanshi.xy/MLLM_RAFT/Qwen2.5-VL-Finetune/qwen_models_raft_cw0
OUTPUT_DIR=/data/yanshi.xy/MLLM_RAFT/Qwen2.5-VL-Finetune/qwen_mathverse_cw0
...
for i in {1..6};do
    ...
    if [ ! -f "$ANSWER_FILE" ]; then
        ...
        CUDA_VISIBLE_DEVICES=4 python evaluation/infer_mathverse.py \
