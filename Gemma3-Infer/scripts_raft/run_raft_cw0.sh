...
CHECKPOINT_ROOT="/data/yanshi.xy/MLLM_RAFT/Gemma3-Infer/gemma_models_raft_cw0"
...
for ((i=1; i<=$EPOCHS; i++)); do
    ...
    # # 输入数据路径
    data_name=geo_train_gemma3_$((i-1))_cw0
    INPUT_DATA="$DATA_ROOT/$data_name.json"
    INTER_DATA="$DATA_ROOT/gemma3_inter_data${i}_cw0.json"
    ...
    # # 最终输出数据路径
    OUTPUT_DATA="$DATA_ROOT/geo_train_gemma3_${i}_cw0.json"
