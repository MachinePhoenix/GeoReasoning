...
MODEL_BASE=/data/yanshi.xy/MLLM_RAFT/Gemma3-Infer/cold_start_fixUnderfitting
OUTPUT_DIR=/data/yanshi.xy/MLLM_RAFT/Gemma3-Infer/gemma_mathverse_test_cold_start
...
for i in {4..15};do
    ...
    if [ ! -f "$ANSWER_FILE" ]; then
        ...
        CUDA_VISIBLE_DEVICES=3 python evaluation/infer_mathverse.py \
