...
MODEL_BASE=/data/yanshi.xy/MLLM_RAFT/Gemma3-Infer/gemma_models_raft_cw0_dataNoUpdate
OUTPUT_DIR=/data/yanshi.xy/MLLM_RAFT/Gemma3-Infer/gemma_mathverse_cw0_dataNoUpdate
...
for i in {1..5};do
    ...
    if [ ! -f "$ANSWER_FILE" ]; then
        ...
        CUDA_VISIBLE_DEVICES=0 python evaluation/infer_mathverse.py \
