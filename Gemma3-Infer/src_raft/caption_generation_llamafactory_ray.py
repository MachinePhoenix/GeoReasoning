...
import pdb
import sys
local_path = 'your_path_to_LLaMA-Factory/src'
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name_or_path", required=True, type=str, help="model path")
    ...
    parser.add_argument("--questions_path", required=True, help="QA data path")
    parser.add_argument("--pipeline_parallel_size", type=int, default=1)
    parser.add_argument("--main_gpus", nargs='+', type=int, default=[0], help="GPU list")
